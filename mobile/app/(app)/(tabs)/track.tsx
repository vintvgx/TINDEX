 ...
 * 
 * This screen shows options tracking information with three tabs:
 * - Tracked: Shows all contracts the user is tracking
 * - Followed: Shows contracts from stocks the user is following
 * - Search: Allows searching for tickers and viewing their options
 */
const TrackScreen = () => {
