  ...
  const query = useQuery({
    ...
    queryFn: async (): Promise<TickerResponse> => {
      ...
      try {
        ...
        // just hangs the screen forever instead of ever reaching the mock-
        // data fallback below. 20s is generous for the request above while
        // still bounding the wait to something finite.
